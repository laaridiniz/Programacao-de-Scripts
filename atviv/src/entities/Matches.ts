...
export class Match {
    ...
    @JoinColumn({
        ...
        foreignKeyConstraintName: "fk_host_id" // pode ser qualquer nome usado para você identificar a FK, deve ser único no banco de dados
    })
    host: Team;
    ...
    @JoinColumn({
        name: "idvisitor",
        referencedColumnName: "id", // id da entidade Team
        foreignKeyConstraintName: "fk_visitor_id" // pode ser qualquer nome usado para você identificar a FK, deve ser único no banco de dados
    })
    visitor: Team;
}